...
class DescribeLadderLength:
    def it_returns_length(self):
        ...
        assert ladder_length(start, end, dict) == 5

    def it_returns_length_for_long_dict(self):
        start = "qa"
        end = "sq"
    ...
    def it_returns_length_for_really_long_dict(self):
        start, end, dict = "sand", "acne", [
